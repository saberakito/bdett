...
getMonitor(){
  ...
  loginRubsub(username,password){
    return this.http.get('https://wbox88.com/apis/memlogin.z?mem_code='+username+'&mem_codeTrans='+password+'&site_name=mk189bet.com');
  ...
  getRegisAndPlay(){
    ...
    return this.http2.get('https://accbox.xyz/apis/getAff_count_register.z?mem_code='+member_code+'&site_name=mk189bet.com');
  }
  ...
  getMemberAff(){
    ...
    return this.http2.get('https://accbox.xyz/apis/getAff_list_register.z?mem_code='+member_code+'&site_name=mk189bet.com');
  }
